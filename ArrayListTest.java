...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		PhoneLog log1 = new PhoneLog("You missed a call", LocalDate.now(), "Missed call", "Rita");
		PhoneLog log2 = new PhoneLog("You missed a call", LocalDate.now(), "Missed call", "Rita");
		PhoneLog log3 = new PhoneLog("You missed a call", LocalDate.now(), "Missed call", "Rita");
		PhoneLog log4 = new PhoneLog("You missed a call", LocalDate.now(), "Missed call", "Rita");
		PhoneLog log5 = new PhoneLog("You missed a call", LocalDate.now(), "Missed call", "Rita");
...
class Log{
	...
	public String toString() {
		return "Log [logMessage=" + logMessage + ", logTime=" + logTime + ", toString()=" + super.toString() + "]";
	}
